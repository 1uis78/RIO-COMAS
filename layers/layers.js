...
var lyr_AP_23821_FBD_F6940_RT1dem_1 = new ol.layer.Image({
                            opacity: 1,
                            title: "AP_23821_FBD_F6940_RT1.dem",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/AP_23821_FBD_F6940_RT1dem_1.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-8407493.298968, -1379388.179566, -8324354.442580, -1303350.794558]
                            })
                        });
...
var lyr_c_acc_6 = new ol.layer.Image({
    ...
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [-8379113.756159, -1330061.156895, -8357975.668897, -1307129.465804]
                            })
                        });
...
lyr_GoogleHybrid_0.setVisible(true);lyr_AP_23821_FBD_F6940_RT1dem_1.setVisible(true);lyr_acc_2.setVisible(true);lyr_dir_3.setVisible(true);lyr_fill_4.setVisible(true);lyr_c_shp_5.setVisible(true);lyr_c_acc_6.setVisible(true);lyr_c_cauce_7.setVisible(true);lyr_c_curvas_8.setVisible(true);lyr_c_fill_9.setVisible(true);lyr_c_reclass_10.setVisible(true);lyr_c_rios_11.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_AP_23821_FBD_F6940_RT1dem_1,lyr_acc_2,lyr_dir_3,lyr_fill_4,lyr_c_shp_5,lyr_c_acc_6,lyr_c_cauce_7,lyr_c_curvas_8,lyr_c_fill_9,lyr_c_reclass_10,lyr_c_rios_11];
lyr_c_shp_5.set('fieldAliases', {'ID': 'ID', 'VALUE': 'VALUE', 'NAME': 'NAME', 'a_Km2': 'a_Km2', 'p_Km': 'p_Km', });
...
lyr_c_shp_5.set('fieldImages', {'ID': 'TextEdit', 'VALUE': 'TextEdit', 'NAME': 'TextEdit', 'a_Km2': '', 'p_Km': '', });
...
lyr_c_shp_5.set('fieldLabels', {'ID': 'no label', 'VALUE': 'no label', 'NAME': 'no label', 'a_Km2': 'no label', 'p_Km': 'no label', });
